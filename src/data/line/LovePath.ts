export const LovePath = new Map<number, { path: string; min: number; max: number; doc: string }>([
  ...
  [3, { path: "生育", min: 2, max: 5, doc: `你迎来自己的孩子，感受新生命带来的喜悦。` }],
  [4, { path: "第二代结婚", min: 25, max: 32, doc: `爱情线文案待填充4` }],
  [5, { path: "生第三代", min: 2, max: 5, doc: `爱情线文案待填充5` }],
  [6, { path: "第三代结婚", min: 25, max: 32, doc: `爱情线文案待填充6` }]
]);
